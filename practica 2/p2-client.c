    ...
    do{
        ...
        case 1:
            ...
            if(atoi(sourceId)>0 && atoi(sourceId)<1161){
                memcpy(query.sourceid, &sourceId, sizeof(sourceId));     // Envio del sourceid de la busqueda por la tuberia al lector
                printf("Su dirección de ID de origen es valido.\n");
            }else{
        ...
        case 2:
            ...
            if(atoi(dtsId)>0 && atoi(dtsId)<1161){  
                memcpy(query.dstid, &dtsId, sizeof(dtsId));     // Envio del dstId de la busqueda por la tuberia al lector
                printf("Su dirección de ID de destino es valido.\n");
            }else{
        ...
        case 3:
            ...
            if(hod>=0 && hod<=23){
                query.hod = hod; // Envio de la hota del día de la busqueda por la tuberia al lector}
                printf("Su hora del dia es valida.\n");
            }else{
